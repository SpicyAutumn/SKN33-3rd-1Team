...
8. [2차 회의 결과 후속 이행 기록](03_post_meeting_reviews/post_meeting_topic_refinement_log.md) · [HTML](03_post_meeting_reviews/post_meeting_topic_refinement_log.html)
9. [데이터 확보 가능성 검증서](04_data_validation/data_feasibility_check.md)
...
| `03_post_meeting_reviews` | 2차 회의 결과에 따른 두 후보의 후속 보완 | 팀 검토 전 초안 |
| `04_data_validation` | 공식 데이터·라이선스·검색 가능성 검증 | 검증 예정 |
...
팀 회의에서 우선 데이터 검증 후보 하나를 정한 뒤, 공식 데이터 10건을 먼저 수집합니다. 출처·라이선스·메타데이터·RAG 검색 가능성을 확인한 후 통과한 후보만 30~50건으로 확장합니다.
